...
class StringUtilityTest extends TestCase
{
    ...
    public function testContainsEmailAddress()
    {
        $validStrings = [
            'my e-mail address is will.buckner [at] eggheads [dot] org',
    ...
    public function testExtractEmailAddress()
    {
    ...
    public function testRemoveEmailAddress()
    {
        $this->assertSame(
    ...
    public function disabledtestIsCityStateZip()
    {
        $validCityStateZips = [
            'Alpharetta, GA  30004',
            'O Fallon, IL  62269',
    ...
    public function testMakeFirstInitialName()
    {
        $this->assertSame(
    ...
    public function testEscapeSingleQuotes()
    {
        $this->assertSame(
