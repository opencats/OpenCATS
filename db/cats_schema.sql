...
/* Fresh installs select Bootstrap; migration 394 preserves existing selections. */
INSERT INTO `settings` (`setting`, `value`, `settings_type`) VALUES ('activeBoard', 'OpenCATS Bootstrap 5.3', 4);
