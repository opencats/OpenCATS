...
<?php TemplateUtility::printHeader(__('Lists'), array( 'js/highlightrows.js', 'js/sweetTitles.js', 'js/export.js', 'js/dataGrid.js', 'js/dataGridFilters.js', 'js/lists.js')); ?>
        ...
        <div id="contents">
            <table width="100%">
                <tr>
                    ...
                    <td><h2><?php echo __("Lists");?>: <?php $this->_($this->listRS['description']); ?></h2></td>
                    <td align="right">
                        ...
                        <a href="javascript:void(0);" onclick="deleteListFromListView(<?php $this->_($this->listRS['savedListID']); ?>, <?php $this->_($this->listRS['numberEntries']); ?>);" style="text-decoration:none;"><img src="images/actions/delete.gif" border="0">&nbsp;<?php echo __("Delete List");?></a>
                    </td>
                </tr>
            </table>
