...
{   
    ...
    public function __construct($siteID, $parameters, $misc)
    {
        ...
        $this->_classColumns = array(
            ...
            __('List Type') =>      array('pagerRender'    => 'return ($rsData[\'isDynamic\']==1?\'Dynamiczna\':\'Statyczna\');',
            ...
            __('Data Type') =>      array('select'         => 'data_item_type.short_description AS dataItemTypeSortDesc', 
            						  ...
            						  'pagerRender'    => '$ret = $rsData[\'dataItemType\']; return EnumTypeEnum::dataItemType()->enumByAttr(\'dbValue\',$ret)->desc;',
