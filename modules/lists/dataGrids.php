...
class ListsDataGrid extends DataGrid
{
    ...
    public function __construct($siteID, $parameters, $misc)
    {
        ...
        $this->_classColumns = [
            ...
            'List Type' => [
                'pagerRender' => 'return ($rsData[\'isDynamic\']==1?\'Dynamic\':\'Static\');',
            ...
            'Data Type' => [
                'select' => 'data_item_type.short_description AS dataItemTypeSortDesc',
            ...
            'Created' => [
                'select' => 'DATE_FORMAT(saved_list.date_created, \'%m-%d-%y\') AS dateCreated',
            ...
            'Modified' => [
                'select' => 'DATE_FORMAT(saved_list.date_modified, \'%m-%d-%y\') AS dateModified',
