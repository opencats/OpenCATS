...
class duplicatesListByViewDataGrid extends DuplicatesDataGrid
{
    public function __construct($siteID, $parameters, $misc)
    {
        ...
        $this->_defaultColumns = array(
         ...
         parent::__construct("duplicates:duplicatesListByViewDataGrid",
...
class duplicatesSavedListByViewDataGrid extends DuplicatesDataGrid
{
    public function __construct($siteID, $parameters, $misc)
    {
        $this->_tableWidth = new Width(100, '%');;
        ...
        $this->_defaultColumns = array(
         ...
         parent::__construct("duplicates:duplicatesSavedListByViewDataGrid",
                             $siteID, $parameters, $misc
                        );
    }
