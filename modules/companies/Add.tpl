        ...
        <div id="contents">
            <table>
                <tr>
                    ...
                    <td><h2><?php echo __("Companies");?>: <?php echo __("Add Company");?></h2></td>
                </tr>
            </table>
            ...
            <form name="addCompanyForm" id="addCompanyForm" action="<?php echo(CATSUtility::getIndexName()); ?>?m=companies&amp;a=add" method="post" onsubmit="return checkAddForm(document.addCompanyForm);" autocomplete="off">
                ...
                <table class="editTable" width="100%">
                    <tr>
                        ...
                        <td rowspan="5" align="left" valign="top">
                            <?php $freeformTop = '<p class="freeformtop"><?php echo __("Cut and paste freeform address here.");?></p>'; ?>
                            ...
                            <?php $freeformBottom = '<p class="freeformbottom"><?php echo __("Cut and paste freeform address here.");?></p>'; ?>
                ...
                <input type="submit" class="button" value="<?php echo __("Add Company");?>" />&nbsp;
                <input type="reset"  class="button" value="<?php echo __("Reset");?>" />&nbsp;
                <input type="button" class="button" value="<?php echo __("Back to Companies");?>" onclick="javascript:goToURL('<?php echo(CATSUtility::getIndexName()); ?>?m=companies&amp;a=show');" />
            </form>
