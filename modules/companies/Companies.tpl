...
<?php TemplateUtility::printHeader(__('Companies'), array('js/highlightrows.js', 'js/export.js', 'js/dataGrid.js', 'js/dataGridFilters.js')); ?>
        ...
        <div id="contents">
            <table width="100%">
                <tr>
                    ...
                    <td><h2><?php echo __("Companies");?>: <?php echo __("Home");?></h2></td>
                    <td align="right">
                            ...
                            <table class="viewSelector">
                                <tr>
                                    ...
                                    <td valign="top" align="right" nowrap="nowrap">
                                        ...
                                        <label for="onlyMyCompanies"><?php echo __("Only My Companies");?></label>&nbsp;
                                    </td>
                                    <td valign="top" align="right" nowrap="nowrap">
                                        ...
                                        <label for="onlyHotCompanies"><?php echo __("Only Hot Companies");?></label>&nbsp;
                                    </td>
                                </tr>
                            </table>
                        </form>
            ...
            <p class="note">
                <span style="float:left;"><?php echo __("Companies");?>  -
                    <?php echo __("Page");?> <?php echo($this->dataGrid->getCurrentPageHTML()); ?>
                    (<?php echo($this->dataGrid->getNumberOfRows()); ?> <?php echo __("Items");?>)
                    <?php if ($this->dataGrid->getFilterValue('OwnerID') ==  $this->userID): ?>(<?php echo __("Only My Companies");?>)<?php endif; ?>
                    <?php if ($this->dataGrid->getFilterValue('IsHot') == '1'): ?>(<?php echo __("Only Hot Companies");?>)<?php endif; ?>
                </span>
