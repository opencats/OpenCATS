        ...
        <div id="contents">
            <table>
                <tr>
                    ...
                    <td><h2><?php echo __("Companies");?>: <?php echo __("Search Companies");?></h2></td>
                </tr>
            </table>

            <p class="note"><?php echo __("Search Companies");?></p>
                    ...
                    <td>
                        <form name="searchForm" id="searchForm" action="<?php echo(CATSUtility::getIndexName()); ?>" method="get" autocomplete="off">
                            ...
                            <select id="searchMode" name="mode" onclick="advancedSearchConsider();" class="selectBox">
                                <option value="searchByName"<?php if ($this->mode == "searchByName"): ?> selected<?php endif; ?>><?php echo __("Name");?></option>
                                <option value="searchByKeyTechnologies"<?php if ($this->mode == "searchByKeyTechnologies"): ?> selected<?php endif; ?>><?php echo __("Key Technologies");?></option>
                            </select>&nbsp;
                            ...
                            <input type="submit" class="button" id="searchCompanies" name="searchCompanies" value="<?php echo __("Search");?>" />
                ...
                <?php if (!empty($this->rs)): ?>
                    ...
                    <table class="sortable" width="100%" onmouseover="javascript:trackTableHighlight(event)">
                        <tr>
                            ...
                            <th align="left" nowrap="nowrap"><?php echo __("Key Technologies");?></th>
                            <th align="left" nowrap="nowrap">
                        ...
                        <?php foreach ($this->rs as $rowNumber => $data): ?>
                            <tr class="<?php TemplateUtility::printAlternatingRowClass($rowNumber); ?>">
                                <td valign="top" nowrap="nowrap">
                                    ...
                                    <a href="javascript:void(0);" onclick="window.open('<?php echo(CATSUtility::getIndexName()); ?>?m=companies&amp;a=show&amp;companyID=<?php $this->_($data['companyID']); ?>')" title="<?php echo __("View in New Window");?>">
