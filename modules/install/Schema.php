...
class CATSSchema
{
    public static function get()
    {
        ...
        return array(
            ...
            ',
            '387' => '
                ALTER TABLE `activity` MODIFY `joborder_id` INT(11);
                ALTER TABLE `attachment` MODIFY `content_type` VARCHAR(255) COLLATE utf8_unicode_ci;
                ALTER TABLE `attachment` MODIFY `directory_name` VARCHAR(64) COLLATE utf8_unicode_ci;
                ALTER TABLE `attachment` MODIFY `title` VARCHAR(128) COLLATE utf8_unicode_ci;
                ALTER TABLE `candidate` MODIFY `city` VARCHAR(64) COLLATE utf8_unicode_ci;
                ALTER TABLE `candidate` MODIFY `country` VARCHAR(2) COLLATE utf8_unicode_ci;
                ALTER TABLE `candidate` MODIFY `current_employer` VARCHAR(128) COLLATE utf8_unicode_ci;
                ALTER TABLE `candidate` MODIFY `current_pay` VARCHAR(64) COLLATE utf8_unicode_ci;
                ALTER TABLE `candidate` MODIFY `date_available` DATETIME;
                ALTER TABLE `candidate` MODIFY `desired_pay` VARCHAR(64) COLLATE utf8_unicode_ci;
                ALTER TABLE `candidate` MODIFY `email1` VARCHAR(128) COLLATE utf8_unicode_ci;
                ALTER TABLE `candidate` MODIFY `email2` VARCHAR(128) COLLATE utf8_unicode_ci;
                ALTER TABLE `candidate` MODIFY `middle_name` VARCHAR(32) COLLATE utf8_unicode_ci;
                ALTER TABLE `candidate` MODIFY `owner` INT(11);
                ALTER TABLE `candidate` MODIFY `phone_cell` VARCHAR(40) COLLATE utf8_unicode_ci;
                ALTER TABLE `candidate` MODIFY `phone_home` VARCHAR(40) COLLATE utf8_unicode_ci;
                ALTER TABLE `candidate` MODIFY `phone_work` VARCHAR(40) COLLATE utf8_unicode_ci;
                ALTER TABLE `candidate` MODIFY `source` VARCHAR(128) COLLATE utf8_unicode_ci;
                ALTER TABLE `candidate` MODIFY `state` VARCHAR(64) COLLATE utf8_unicode_ci;
                ALTER TABLE `candidate` MODIFY `web_site` VARCHAR(128) COLLATE utf8_unicode_ci;
                ALTER TABLE `candidate` MODIFY `zip` VARCHAR(16) COLLATE utf8_unicode_ci;
                ALTER TABLE `candidate_joborder` MODIFY `added_by` INT(11);
                ALTER TABLE `candidate_joborder` MODIFY `date_submitted` DATETIME;
                ALTER TABLE `candidate_joborder` MODIFY `rating_value` INT(5);
                ALTER TABLE `candidate_source` MODIFY `date_created` DATETIME;
                ALTER TABLE `candidate_source` MODIFY `name` VARCHAR(255) COLLATE utf8_unicode_ci;
                ALTER TABLE `candidate_source` MODIFY `site_id` INT(11);
                ALTER TABLE `candidate_tag` MODIFY `site_id` INT(10) UNSIGNED;
                ALTER TABLE `career_portal_questionnaire` MODIFY `description` VARCHAR(255);
                ALTER TABLE `career_portal_questionnaire_answer` MODIFY `action_key_skills` VARCHAR(255);
                ALTER TABLE `career_portal_questionnaire_answer` MODIFY `action_source` VARCHAR(128);
                ALTER TABLE `career_portal_questionnaire_question` MODIFY `maximum_length` INT(11);
                ALTER TABLE `career_portal_questionnaire_question` MODIFY `minimum_length` INT(11);
                ALTER TABLE `career_portal_template` MODIFY `career_portal_name` VARCHAR(255);
                ALTER TABLE `career_portal_template_site` MODIFY `career_portal_name` VARCHAR(255);
                ALTER TABLE `company` MODIFY `billing_contact` INT(11);
                ALTER TABLE `company` MODIFY `city` VARCHAR(64) COLLATE utf8_unicode_ci;
                ALTER TABLE `company` MODIFY `country` VARCHAR(2) COLLATE utf8_unicode_ci;
                ALTER TABLE `company` MODIFY `entered_by` INT(11);
                ALTER TABLE `company` MODIFY `fax_number` VARCHAR(40) COLLATE utf8_unicode_ci;
                ALTER TABLE `company` MODIFY `import_id` INT(11);
                ALTER TABLE `company` MODIFY `is_hot` INT(1);
                ALTER TABLE `company` MODIFY `owner` INT(11);
                ALTER TABLE `company` MODIFY `phone1` VARCHAR(40) COLLATE utf8_unicode_ci;
                ALTER TABLE `company` MODIFY `phone2` VARCHAR(40) COLLATE utf8_unicode_ci;
                ALTER TABLE `company` MODIFY `state` VARCHAR(64) COLLATE utf8_unicode_ci;
                ALTER TABLE `company` MODIFY `url` VARCHAR(128) COLLATE utf8_unicode_ci;
                ALTER TABLE `company` MODIFY `zip` VARCHAR(16) COLLATE utf8_unicode_ci;
                ALTER TABLE `company_department` MODIFY `created_by` INT(11);
                ALTER TABLE `company_department` MODIFY `name` VARCHAR(128) COLLATE utf8_unicode_ci;
                ALTER TABLE `contact` MODIFY `city` VARCHAR(64) COLLATE utf8_unicode_ci;
                ALTER TABLE `contact` MODIFY `country` VARCHAR(2) COLLATE utf8_unicode_ci;
                ALTER TABLE `contact` MODIFY `email1` VARCHAR(128) COLLATE utf8_unicode_ci;
                ALTER TABLE `contact` MODIFY `email2` VARCHAR(128) COLLATE utf8_unicode_ci;
                ALTER TABLE `contact` MODIFY `is_hot` INT(1);
                ALTER TABLE `contact` MODIFY `owner` INT(11);
                ALTER TABLE `contact` MODIFY `phone_cell` VARCHAR(40) COLLATE utf8_unicode_ci;
                ALTER TABLE `contact` MODIFY `phone_other` VARCHAR(40) COLLATE utf8_unicode_ci;
                ALTER TABLE `contact` MODIFY `phone_work` VARCHAR(40) COLLATE utf8_unicode_ci;
                ALTER TABLE `contact` MODIFY `state` VARCHAR(64) COLLATE utf8_unicode_ci;
                ALTER TABLE `contact` MODIFY `title` VARCHAR(128) COLLATE utf8_unicode_ci;
                ALTER TABLE `contact` MODIFY `zip` VARCHAR(16) COLLATE utf8_unicode_ci;
                ALTER TABLE `email_history` MODIFY `date` DATETIME;
                ALTER TABLE `email_history` MODIFY `user_id` INT(11);
                ALTER TABLE `email_template` MODIFY `tag` VARCHAR(255) COLLATE utf8_unicode_ci;
                ALTER TABLE `email_template` MODIFY `title` VARCHAR(255) COLLATE utf8_unicode_ci;
                ALTER TABLE `extension_statistics` MODIFY `date` DATE;
                ALTER TABLE `extra_field` MODIFY `field_name` VARCHAR(255);
                ALTER TABLE `extra_field` MODIFY `import_id` INT(11);
                ALTER TABLE `extra_field_settings` MODIFY `date_created` DATETIME;
                ALTER TABLE `extra_field_settings` MODIFY `field_name` VARCHAR(255) COLLATE utf8_unicode_ci;
                ALTER TABLE `extra_field_settings` MODIFY `import_id` INT(11);
                ALTER TABLE `feedback` MODIFY `user_id` INT(11);
                ALTER TABLE `history` MODIFY `data_item_id` INT(11);
                ALTER TABLE `history` MODIFY `data_item_type` INT(11);
                ALTER TABLE `history` MODIFY `description` VARCHAR(192) COLLATE utf8_unicode_ci;
                ALTER TABLE `history` MODIFY `entered_by` INT(11);
                ALTER TABLE `history` MODIFY `set_date` DATETIME;
                ALTER TABLE `history` MODIFY `the_field` VARCHAR(64) COLLATE utf8_unicode_ci;
                ALTER TABLE `http_log` MODIFY `http_user_agent` VARCHAR(255);
                ALTER TABLE `http_log` MODIFY `query_string` VARCHAR(255);
                ALTER TABLE `http_log` MODIFY `request_method` VARCHAR(16);
                ALTER TABLE `http_log` MODIFY `request_uri` VARCHAR(255);
                ALTER TABLE `http_log` MODIFY `script_filename` VARCHAR(255);
                ALTER TABLE `http_log` MODIFY `script_name` VARCHAR(255);
                ALTER TABLE `http_log_types` MODIFY `description` VARCHAR(255);
                ALTER TABLE `import` MODIFY `added_lines` INT(11);
                ALTER TABLE `import` MODIFY `date_created` DATETIME;
                ALTER TABLE `joborder` MODIFY `client_job_id` VARCHAR(32) COLLATE utf8_unicode_ci;
                ALTER TABLE `joborder` MODIFY `company_department_id` INT(11);
                ALTER TABLE `joborder` MODIFY `company_id` INT(11);
                ALTER TABLE `joborder` MODIFY `contact_id` INT(11);
                ALTER TABLE `joborder` MODIFY `country` VARCHAR(2) COLLATE utf8_unicode_ci;
                ALTER TABLE `joborder` MODIFY `duration` VARCHAR(64) COLLATE utf8_unicode_ci;
                ALTER TABLE `joborder` MODIFY `openings` INT(11);
                ALTER TABLE `joborder` MODIFY `owner` INT(11);
                ALTER TABLE `joborder` MODIFY `questionnaire_id` INT(11);
                ALTER TABLE `joborder` MODIFY `rate_max` VARCHAR(255) COLLATE utf8_unicode_ci;
                ALTER TABLE `joborder` MODIFY `recruiter` INT(11);
                ALTER TABLE `joborder` MODIFY `salary` VARCHAR(64) COLLATE utf8_unicode_ci;
                ALTER TABLE `joborder` MODIFY `start_date` DATETIME;
                ALTER TABLE `joborder` MODIFY `state` VARCHAR(64) COLLATE utf8_unicode_ci;
                ALTER TABLE `module_schema` MODIFY `name` VARCHAR(64) COLLATE utf8_unicode_ci;
                ALTER TABLE `module_schema` MODIFY `version` INT(11);
                ALTER TABLE `mru` MODIFY `user_id` INT(11);
                ALTER TABLE `queue` MODIFY `date_completed` DATETIME;
                ALTER TABLE `queue` MODIFY `response` VARCHAR(255);
                ALTER TABLE `saved_list` MODIFY `date_created` DATETIME;
                ALTER TABLE `saved_list` MODIFY `date_modified` DATETIME;
                ALTER TABLE `saved_list_entry` MODIFY `date_created` DATETIME;
                ALTER TABLE `saved_search` MODIFY `data_item_type` INT(11);
                ALTER TABLE `saved_search` MODIFY `date_created` DATETIME;
                ALTER TABLE `saved_search` MODIFY `is_custom` INT(1);
                ALTER TABLE `saved_search` MODIFY `site_id` INT(11);
                ALTER TABLE `saved_search` MODIFY `user_id` INT(11);
                ALTER TABLE `settings` MODIFY `value` VARCHAR(255) COLLATE utf8_unicode_ci;
                ALTER TABLE `site` MODIFY `company_id` INT(11);
                ALTER TABLE `site` MODIFY `is_free` INT(1);
                ALTER TABLE `site` MODIFY `unix_name` VARCHAR(128) CHARACTER SET utf8;
                ALTER TABLE `system` MODIFY `uid` INT(20);
                ALTER TABLE `tag` MODIFY `description` VARCHAR(500);
                ALTER TABLE `tag` MODIFY `site_id` INT(11) UNSIGNED;
                ALTER TABLE `tag` MODIFY `tag_parent_id` INT(10) UNSIGNED;
                ALTER TABLE `tag` MODIFY `title` VARCHAR(255);
                ALTER TABLE `user` MODIFY `categories` VARCHAR(192) COLLATE utf8_unicode_ci;
                ALTER TABLE `user` MODIFY `city` VARCHAR(64) COLLATE utf8_unicode_ci;
                ALTER TABLE `user` MODIFY `company` VARCHAR(255) COLLATE utf8_unicode_ci;
                ALTER TABLE `user` MODIFY `country` VARCHAR(128) COLLATE utf8_unicode_ci;
                ALTER TABLE `user` MODIFY `email` VARCHAR(128) COLLATE utf8_unicode_ci;
                ALTER TABLE `user` MODIFY `session_cookie` VARCHAR(256) COLLATE utf8_unicode_ci;
                ALTER TABLE `user` MODIFY `state` VARCHAR(64) COLLATE utf8_unicode_ci;
                ALTER TABLE `user` MODIFY `zip_code` VARCHAR(16) COLLATE utf8_unicode_ci;
                ALTER TABLE `user_login` MODIFY `date_refreshed` DATETIME;
                ALTER TABLE `user_login` MODIFY `host` VARCHAR(255) COLLATE utf8_unicode_ci;
                ALTER TABLE `user_login` MODIFY `user_agent` VARCHAR(255) COLLATE utf8_unicode_ci;
                ALTER TABLE `user_login` MODIFY `user_id` INT(11);
