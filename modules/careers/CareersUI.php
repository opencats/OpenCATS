...
class CareersUI extends UserInterface
{
    ...
    private function _makeApplyValidator($template)
    {
        ...
        if (strpos($template['Content'], '<input-phoneWork req>') !== false)
        {
            $validator .= '
        ...
        if (strpos($template['Content'], '<input-email1 req>') !== false)
        {
            $validator .= '
        ...
        if (strpos($template['Content'], '<input-currentEmployer req>') !== false)
        {
            $validator .= '
