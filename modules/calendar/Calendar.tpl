...
<?php TemplateUtility::printHeader('Calendar', array('js/calendar/Calendar.css', 'js/highlightrows.js', 'js/calendar/Calendar.js', 'js/calendar/CalendarUI.js', 'js/calendar/validator.js')); ?>
