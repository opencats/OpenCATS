        ...
        <div id="contents">
            ...
            <table>
                <tr>
                    ...
                    <td><h2><?php echo __("Candidates");?>: <?php echo __("Add Candidate");?></h2></td>
                </tr>
            </table>

<?php endif; ?>

            <p class="note<?php if ($this->isModal): ?>Unsized<?php endif; ?>"><?php echo __("Basic Information");?></p>
            ...
            <table style="font-weight:bold; border: 1px solid #000; background-color: #ffed1a; padding:5px; display:none; margin-bottom:7px;" width="100%" id="candidateAlreadyInSystemTable">
                <tr>
                    <td class="tdVertical">
                        <?php echo __("This profile may already be in the system.");?>&nbsp;&nbsp;<?php echo __("Possible duplicate candidate profile");?>:&nbsp;&nbsp;
            ...
            <form name="addCandidateForm" id="addCandidateForm" enctype="multipart/form-data" action="<?php echo($URI); ?>" method="post" onsubmit="return (checkAddForm(document.addCandidateForm) && onSubmitEmailInSystem() && onSubmitPhoneInSystem());" autocomplete="off" enctype="multipart/form-data">
                ...
                <table class="editTable">
                                ...
                                <table cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                        <td valign="middle" align="right" colspan="2">
                                            ...
                                            <input type="button" id="documentLoad" value="<?php echo __("Upload");?>" onclick="loadDocumentFileContents();" disabled />
                                            &nbsp;
                                        </td>
                                    </tr>
                                    <tr>
                                        <td valign="top" align="left" colspan="2">
                                            ...
                                            (<b>hint:</b> <?php echo __("you may also paste the resume contents");?>)
                                            <br /><br />
                                            <?php if (LicenseUtility::isProfessional() || file_exists('modules/asp')): ?>
                                            <?php echo __("Need to upload multiple resumes?");?> <a href="<?php echo CATSUtility::getIndexName(); ?>?m=import&a=massImport"><?php echo __("Click here!");?></a>
                                            <?php else: ?>
                                                <?php if ($this->parsingStatus['parseLimit'] >= 0 && (($used = $this->parsingStatus['parseUsed']) / ($limit = $this->parsingStatus['parseLimit']) * 100) > 50): ?>
                                                    ...
                                                    <?php if ($used == $limit): ?>
                                                        ...
                                                        <br />
                                                        <?php echo __("Enter resume information manually or");?>
                                                        <a href="http://www.catsone.com/?a=getcats"><?php echo __("upgrade to CATS Professional");?></a>.
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                            <?php endif; ?>
                                            </div>
                    ...
                    <tr>
                        <td class="tdVertical">
                            <label id="middleNameLabel" for="middleName"><?php echo __("Middle Name");?>:</label>
                        </td>
                        <td class="tdData">
                    ...
                    <tr>
                        <td class="tdVertical">
                            <label id="emailLabel" for="email1"><?php echo __("E-Mail");?>:</label>
                        </td>
                        <td class="tdData">
                    ...
                    <tr>
                        <td class="tdVertical">
                            <label id="webSiteLabel" for="webSite"><?php echo __("Web Site");?>:</label>
                        </td>
                        <td class="tdData">
                    ...
                    <tr>
                        ...
                        <td class="tdData">
                            ...
                            <input type="button" tabindex="92" onclick="CityState_populate('zip', 'ajaxIndicator');" value="<?php echo __("Lookup");?>" />
                    ...
                    <tr>
                        <td class="tdVertical">
                            <label id="stateLabel" for="state"><?php echo __("Best Time to Call");?>:</label>
                        </td>
                        <td class="tdData">
                            ...
                            <?php if ($this->associatedAttachment == 0): ?>
                                <nobr> <?php /* FIXME:  remove nobr stuff */ ?>
                                    <?php if (isset($this->overAttachmentQuota)): ?>
                                        <span style="font-size:10px;">(<?php echo __("You have already reached your limit of");?> <?php echo(FREE_ACCOUNT_SIZE/1024); ?> <?php echo __("MB of attachments, and cannot add additional file attachments without upgrading to CATS Professional Hosted.");?>)<br /></font><?php echo __("Copy and Paste Resume");?>:&nbsp;
                                    <?php else: ?>
                    ...
                    <tr>
                        <td colspan="3" align="left" valign="top">
                            ...
                            <div id="textResumeTD" <?php if($this->associatedTextResume === false): ?>style="display:none;"<?php endif; ?>>
                                <p class="freeformtop" style="width: 700px;"><?php echo __("Cut and paste resume text here.");?></p>
                ...
                <?php if($this->EEOSettingsRS['enabled'] == 1): ?>
                    <p class="note<?php if ($this->isModal): ?>Unsized<?php endif; ?>" style="margin-top: 5px;"><?php echo __("EEO Information");?></p>
                    <table class="editTable">
                             ...
                             <tr>
                                ...
                                <td class="tdData">
                                    <select id="gender" name="gender" class="inputbox" style="width:200px;" tabindex="<?php echo($tabIndex++); ?>">
                                        ...
                                        <option value="M"<?php if (isset($this->preassignedFields['gender']) && $this->preassignedFields['gender'] == 'M') echo ' selected'; ?>><?php echo __("Male");?></option>
                                        <option value="F"<?php if (isset($this->preassignedFields['gender']) && $this->preassignedFields['gender'] == 'F') echo ' selected'; ?>><?php echo __("Female");?></option>
                                    </select>
                                </td>
                             </tr>
                         <?php endif; ?>
                         <?php if ($this->EEOSettingsRS['ethnicTracking'] == 1): ?>
                             <tr>
                                <td class="tdVertical">
                                    <label id="canRelocateLabel" for="canRelocate"><?php echo __("Ethnic Background");?>:</label>
                                </td>
                                <td class="tdData">
                                    <select id="race" name="race" class="inputbox" style="width:200px;" tabindex="<?php echo($tabIndex++); ?>">
                                        <option selected="selected" value="">----</option>
                                        <option value="1"<?php if (isset($this->preassignedFields['race']) && $this->preassignedFields['race'] == '1') echo ' selected'; ?>><?php echo __("American Indian");?></option>
                                        <option value="2"<?php if (isset($this->preassignedFields['race']) && $this->preassignedFields['race'] == '2') echo ' selected'; ?>><?php echo __("Asian or Pacific Islander");?></option>
                                        <option value="3"<?php if (isset($this->preassignedFields['race']) && $this->preassignedFields['race'] == '3') echo ' selected'; ?>><?php echo __("Hispanic or Latino");?></option>
                                        <option value="4"<?php if (isset($this->preassignedFields['race']) && $this->preassignedFields['race'] == '4') echo ' selected'; ?>><?php echo __("Non-Hispanic Black");?></option>
                                        <option value="5"<?php if (isset($this->preassignedFields['race']) && $this->preassignedFields['race'] == '5') echo ' selected'; ?>><?php echo __("Non-Hispanic White");?></option>
                                    </select>
                                </td>
                             </tr>
                         <?php endif; ?>
                         <?php if ($this->EEOSettingsRS['veteranTracking'] == 1): ?>
                             <tr>
                                <td class="tdVertical">
                                    <label id="canRelocateLabel" for="canRelocate"><?php echo __("Veteran Status");?>:</label>
                                </td>
                                <td class="tdData">
                                    <select id="veteran" name="veteran" class="inputbox" style="width:200px;" tabindex="<?php echo($tabIndex++); ?>">
                                        <option selected="selected" value="">----</option>
                                        <option value="1"<?php if (isset($this->preassignedFields['veteran']) && $this->preassignedFields['veteran'] == '1') echo ' selected'; ?>><?php echo __("No");?></option>
                                        <option value="2"<?php if (isset($this->preassignedFields['veteran']) && $this->preassignedFields['veteran'] == '2') echo ' selected'; ?>><?php echo __("Eligible Veteran");?></option>
                                        <option valie="3"<?php if (isset($this->preassignedFields['veteran']) && $this->preassignedFields['veteran'] == '3') echo ' selected'; ?>><?php echo __("Disabled Veteran");?></option>
                                        <option value="4"<?php if (isset($this->preassignedFields['veteran']) && $this->preassignedFields['veteran'] == '4') echo ' selected'; ?>><?php echo __("Eligible and Disabled");?></option>
                                    </select>
                                </td>
                             </tr>
                         <?php endif; ?>
                         <?php if ($this->EEOSettingsRS['disabilityTracking'] == 1): ?>
                             <tr>
                                <td class="tdVertical">
                                    <label id="canRelocateLabel" for="canRelocate"><?php echo __("Disability Status");?>:</label>
                                </td>
                                <td class="tdData">
                                    <select id="disability" name="disability" class="inputbox" style="width:200px;" tabindex="<?php echo($tabIndex++); ?>">
                                        <option selected="selected" value="">----</option>
                                        <option value="No"<?php if (isset($this->preassignedFields['disability']) && $this->preassignedFields['disability'] == 'No') echo ' selected'; ?>><?php echo __("No");?></option>
                                        <option value="Yes"<?php if (isset($this->preassignedFields['disability']) && $this->preassignedFields['disability'] == 'Yes') echo ' selected'; ?>><?php echo __("Yes");?></option>
                                    </select>
                                </td>
                             </tr>
                         <?php endif; ?>
                ...
                <p class="note<?php if ($this->isModal): ?>Unsized<?php endif; ?>" style="margin-top: 5px;"><?php echo __("Other");?></p>
                <table class="editTable">
                    ...
                    <tr>
                        <td class="tdVertical">
                            <label id="canRelocateLabel" for="canRelocate"><?php echo __("Can Relocate");?>:</label>
                        </td>
                        <td class="tdData">
                    ...
                    <tr>
                        <td class="tdVertical">
                            <label id="dateAvailableLabel" for="dateAvailable"><?php echo __("Date Available");?>:</label>
                        </td>
                        <td class="tdData">
                    ...
                    <tr>
                        <td class="tdVertical">
                            <label id="currentEmployerLabel" for="currentEmployer"><?php echo __("Current Employer");?>:</label>
                        </td>
                        <td class="tdData">
                    ...
                    <tr>
                        <td class="tdVertical">
                            <label id="currentPayLabel" for="currentEmployer"><?php echo __("Current Pay");?>:</label>
                        </td>
                        <td class="tdData">
                    ...
                    <tr>
                        <td class="tdVertical">
                            <label id="desiredPayLabel" for="currentEmployer"><?php echo __("Desired Pay");?>:</label>
                        </td>
                        <td class="tdData">
                    ...
                    <tr>
                        <td class="tdVertical">
                            <label id="sourceLabel" for="sourceSelect"><?php echo __("Source");?>:</label>
                        </td>
                        <td class="tdData">
<?php if ($this->isModal): ?>
...
<?php endif; ?>
                    ...
                    <tr>
                        <td class="tdVertical">
                            <label id="keySkillsLabel" for="keySkills"><?php echo __("Key Skills");?>:</label>
                        </td>
                        <td class="tdData">
                ...
                <input type="submit" tabindex="<?php echo($tabIndex++); ?>" class="button" value="<?php echo __("Add Candidate");?>" />&nbsp;
                <input type="reset"  tabindex="<?php echo($tabIndex++); ?>" class="button" value="<?php echo __("Reset");?>" />&nbsp;
                <?php if ($this->isModal): ?>
                    <input type="button" tabindex="<?php echo($tabIndex++); ?>" class="button" value="<?php echo __("Back to Search");?>" onclick="javascript:goToURL('<?php echo(CATSUtility::getIndexName()); ?>?m=joborders&amp;a=considerCandidateSearch&amp;jobOrderID=<?php echo($this->jobOrderID); ?>');" />
                <?php else: ?>
                    <input type="button" tabindex="<?php echo($tabIndex++); ?>" class="button" value="<?php echo __("Back to Candidates");?>" onclick="javascript:goToURL('<?php echo(CATSUtility::getIndexName()); ?>?m=candidates');" />
                <?php endif; ?>
            </form>
