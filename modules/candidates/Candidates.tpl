...
<main id="main" class="container-fluid py-2 oc-candidates-page">
    <div id="contents" class="oc-candidates-content">
        ...
        <section
            ...
            <div class="d-flex align-items-baseline gap-2 flex-shrink-0">
                <h1 class="h5 fw-semibold mb-0">Candidates</h1>
...
->getJSAddRemoveFilterFromCheckbox(
    ...
    ->getJSAddRemoveFilterFromCheckbox(
        ...
        <section class="card oc-candidates-list">
            <div class="card-body p-2">
                <div class="oc-candidates-filters">
                    <?php $this->dataGrid->drawFilterArea(); ?>
                </div>

                <div class="oc-candidates-datagrid">
            ...
            <div class="card-footer bg-body py-1 px-2">
                <div
                    ...
                    >
                    <div class="oc-candidates-actions">
                        <?php $this->dataGrid->printActionArea(); ?>
                    </div>

                    <div class="oc-candidates-pagination">
        ...
        <?php else: ?>
        <section class="oc-page-header mb-2"><h1 class="h5 fw-semibold mb-0">Candidates</h1></section>
        <section class="card"><div class="card-body p-3">
                <p class="text-body-secondary">Add candidates to keep track of possible applicants for your job orders.</p>
                <?php if ($this->getUserAccessLevel('candidates.add') >= ACCESS_LEVEL_EDIT): ?>
                <a class="btn btn-sm btn-primary" href="<?php echo Template::escapeAttr(CATSUtility::getIndexName()); ?>?m=candidates&amp;a=add">Add Candidate</a>
                <?php endif; ?>
            </div></section>
        <?php endif; ?>
    </div>
