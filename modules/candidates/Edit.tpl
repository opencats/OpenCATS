...
<?php TemplateUtility::printHeader(__('Candidates'), array('modules/candidates/validator.js', 'js/sweetTitles.js', 'js/listEditor.js', 'js/doubleListEditor.js')); ?>
        ...
        <div id="contents">
            <table>
                <tr>
                    ...
                    <td><h2><?php echo __("Candidates");?>: <?php echo __("Edit");?></h2></td>
               </tr>
            </table>

            <p class="note"><?php echo __("Edit Candidate");?></p>
            ...
            <form name="editCandidateForm" id="editCandidateForm" action="<?php echo(CATSUtility::getIndexName()); ?>?m=candidates&amp;a=edit" method="post" onsubmit="return checkEditForm(document.editCandidateForm);" autocomplete="off">
                ...
                <table class="editTable" width="700">
                    <tr>
                        <td class="tdVertical" valign="top" style="height: 28px;">
                            <label id="isHotLabel" for="isHot"><?php echo __("Active");?>:</label>
                        </td>
                        <td class="tdData" >
                            <input type="checkbox" id="isActive" name="isActive"<?php if ($this->data['isActive'] == 1): ?> checked<?php endif; ?> />
                            <img title="<?php echo __("Unchecking this box indicates the candidate is inactive, and will no longer display on the resume search results.");?>" src="images/information.gif" alt="" width="16" height="16" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="tdVertical">
                            <label id="addressLabel" for="address1"><?php echo __("Address");?>:</label>
                        </td>
                        <td class="tdData">
                    ...
                    <tr>
                        <td class="tdVertical">
                            <label id="canRelocateLabel" for="canRelocate"><?php echo __("Best Time To Call");?>:</label>
                        </td>
                        <td class="tdData">
                    ...
                    <tr>
                        <td class="tdVertical" valign="top" style="height: 28px;">
                            <label id="isHotLabel" for="isHot"><?php echo __("Hot Candidate");?>:</label>
                        </td>
                        <td class="tdData" >
                    ...
                    <tr>
                        <td class="tdVertical">
                            <label id="sourceLabel" for="source"><?php echo __("Source");?>:</label>
                        </td>
                        <td class="tdData">
                            <select id="sourceSelect" name="source" class="inputbox" style="width: 150px;" onchange="if (this.value == 'edit') { listEditor('<?php echo __("Sources");?>', 'sourceSelect', 'sourceCSV', false, ''); this.value = '(none)'; } if (this.value == 'nullline') { this.value = '(none)'; }">
                                <option value="edit">(<?php echo __("Edit Sources");?>)</option>
                                <option value="nullline">-------------------------------</option>
                                <?php if ($this->sourceInRS == false): ?>
                                    <?php if ($this->data['source'] != '(<?php echo __("none");?>)'): ?>
                    ...
                    <tr>
                     ...
                     <tr>
                        <td class="tdVertical">
                            <label id="sourceLabel" for="image"><?php echo __("Picture");?>:</label>
                        </td>
                        <td class="tdData">
                            <input type="button" class="button" id="addImage" name="addImage" value="<?php echo __("Edit Profile Picture");?>" style="width:150px;" onclick="showPopWin('<?php echo(CATSUtility::getIndexName()); ?>?m=candidates&amp;a=addEditImage&amp;candidateID=<?php echo($this->candidateID); ?>', 400, 370, null); return false;" />&nbsp;
                        </td>
                    </tr>
                </table>
                ...
                <?php if($this->EEOSettingsRS['enabled'] == 1): ?>
                    <?php if(!$this->EEOSettingsRS['canSeeEEOInfo']): ?>
                        <table class="editTable" width="700">
                            <tr>
                                <td>
                                    <?php echo __("Editing EEO data is disabled.");?>
                                </td>
                            </tr>
                        </tr>
                    ...
                    <?php endif; ?>               
                         ...
                         <?php if ($this->EEOSettingsRS['genderTracking'] == 1): ?>
                             <tr>
                                <td class="tdVertical">
                                    <label id="canRelocateLabel" for="canRelocate"><?php echo __("Gender");?>:</label>
                                </td>
                                <td class="tdData">
                                    <select id="gender" name="gender" class="inputbox" style="width:200px;">
                                        <option value="">----</option>
                                        <option value="m" <?php if (strtolower($this->data['eeoGender']) == 'm') echo('selected'); ?>><?php echo __("Male");?></option>
                                        <option value="f" <?php if (strtolower($this->data['eeoGender']) == 'f') echo('selected'); ?>><?php echo __("Female");?></option>
                                    </select>
                                </td>
                             </tr>
                         <?php endif; ?>
                             ...
                             <tr>
                                ...
                                <td class="tdData">
                                    <select id="race" name="race" class="inputbox" style="width:200px;">
                                        <option value="">----</option>
                                        <option value="1" <?php if ($this->data['eeoEthnicTypeID'] == 1) echo('selected'); ?>><?php echo __("American Indian");?></option>
                                        <option value="2" <?php if ($this->data['eeoEthnicTypeID'] == 2) echo('selected'); ?>><?php echo __("Asian or Pacific Islander");?></option>
                                        <option value="3" <?php if ($this->data['eeoEthnicTypeID'] == 3) echo('selected'); ?>><?php echo __("Hispanic or Latino");?></option>
                                        <option value="4" <?php if ($this->data['eeoEthnicTypeID'] == 4) echo('selected'); ?>><?php echo __("Non-Hispanic Black");?></option>
                                        <option value="5" <?php if ($this->data['eeoEthnicTypeID'] == 5) echo('selected'); ?>><?php echo __("Non-Hispanic White");?></option>
                                    </select>
                                </td>
                             </tr>
                         <?php endif; ?>
                             ...
                             <tr>
                                ...
                                <td class="tdData">
                                    <select id="veteran" name="veteran" class="inputbox" style="width:200px;">
                                        <option value="">----</option>
                                        <option value="1" <?php if ($this->data['eeoVeteranTypeID'] == 1) echo('selected'); ?>><?php echo __("No");?></option>
                                        <option value="2" <?php if ($this->data['eeoVeteranTypeID'] == 2) echo('selected'); ?>><?php echo __("Eligible Veteran");?></option>
                                        <option value="3" <?php if ($this->data['eeoVeteranTypeID'] == 3) echo('selected'); ?>><?php echo __("Disabled Veteran");?></option>
                                        <option value="4" <?php if ($this->data['eeoVeteranTypeID'] == 4) echo('selected'); ?>><?php echo __("Eligible and Disabled");?></option>
                                    </select>
                                </td>
                             </tr>
                         <?php endif; ?>
                             ...
                             <tr>
                                ...
                                <td class="tdData">
                                    <select id="disability" name="disability" class="inputbox" style="width:200px;">
                                        <option value="">----</option>
                                        <option value="No" <?php if ($this->data['eeoDisabilityStatus'] == 'No') echo('selected'); ?>><?php echo __("No");?></option>
                                        <option value="Yes" <?php if ($this->data['eeoDisabilityStatus'] == 'Yes') echo('selected'); ?>><?php echo __("Yes");?></option>
                                    </select>
                                </td>
                             </tr>
                         <?php endif; ?>
                ...
                <input type="reset"  class="button" name="reset"  id="reset"  value="<?php echo __("Reset");?>" onclick="resetFormForeign();" />&nbsp;
                <input type="button" class="button" name="back"   id="back"   value="<?php echo __("Back to Details");?>" onclick="javascript:goToURL('<?php echo(CATSUtility::getIndexName()); ?>?m=candidates&amp;a=show&amp;candidateID=<?php echo($this->candidateID); ?>');" />
            </form>
