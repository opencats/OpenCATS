        ...
        <div id="contents">
            <table>
                <tr>
                    ...
                    <td><h2><?php echo __("Job Orders");?>: <?php echo __("Search Job Orders");?></h2></td>
                </tr>
            </table>

            <p class="note"><?php echo __("Search Job Orders");?></p>
                    ...
                    <td>
                        <form name="searchForm" id="searchForm" action="<?php echo(CATSUtility::getIndexName()); ?>" method="get" autocomplete="off">
                            ...
                            <select id="searchMode" name="mode" onclick="advancedSearchConsider();" class="selectBox">
                                <option value="searchByJobTitle"<?php if ($this->mode == "searchByJobTitle"): ?> selected="selected"<?php endif; ?>><?php echo __("Job Title");?></option>
                                <option value="searchByCompanyName"<?php if ($this->mode == "searchByCompanyName"): ?> selected="selected"<?php endif; ?>><?php echo __("Company Name");?></option>
                            </select>&nbsp;
                            ...
                            <input type="submit" class="button" id="searchJobOrders" name="searchJobOrders" value="<?php echo __("Search");?>" />
                            ...
                            <tr class="<?php TemplateUtility::printAlternatingRowClass($rowNumber); ?>">
                                <td valign="top" nowrap="nowrap">
                                    <input type="checkbox" id="checked_<?php echo($data['jobOrderID']); ?>" name="checked_<?php echo($data['jobOrderID']); ?>" />
                                     <a href="javascript:void(0);" onclick="window.open('<?php echo(CATSUtility::getIndexName()); ?>?m=joborders&amp;a=show&amp;jobOrderID=<?php $this->_($data['jobOrderID']); ?>')" title="<?php echo __("View in New Window");?>">
