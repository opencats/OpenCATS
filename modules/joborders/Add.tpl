...
<?php TemplateUtility::printHeader('Job Orders', array('js/joborders/validator.js',  'js/company.js', 'js/sweetTitles.js', 'js/suggest.js', 'js/joborder.js', 'js/lib.js', 'js/listEditor.js', 'js/ckeditor/ckeditor.js')); ?>
