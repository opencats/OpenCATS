...
<?php TemplateUtility::printTabs($this->active, $this->subActive); ?>
    <div id="main">
		...
		<p class="note"><?php echo __("LDAP Enabled. Password cannot be changed from OpenCATS");?></p>
	    <?php endif; ?>
            <p class="note"><?php echo __("Change Password");?></p>
            ...
            <form name="changePasswordForm" id="changePasswordForm" action="<?php echo(CATSUtility::getIndexName()); ?>?m=settings&amp;a=changePassword" method="post" onsubmit="return checkChangePasswordForm(document.changePasswordForm);">
                ...
                <table class="searchTable">
                    <tr>
                        <td colspan="2">
                            <span class="bold"><?php echo __("Change Password");?></span>
                            <br />
                            <br />
                    ...
                    <tr>
                        <td>
                            <label id="currentPasswordLabel" for="currentPassword"><?php echo __("Current Password");?>:</label>&nbsp;
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <label id="newPasswordLabel" for="newPassword"><?php echo __("New Password");?>:</label>&nbsp;
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <label id="retypeNewPasswordLabel" for="retypeNewPassword"><?php echo __("Retype New Password");?>:</label>&nbsp;
                        </td>
                        <td>
                    ...
                    <tr>
                        <td colspan="2">
                            <br />
                            <input type="submit" class="button" id="changePassword" name="changePassword" value="<?php echo __("Change Password");?>" />
                            <input type="reset"  class="button" id="reset"          name="reset"          value="<?php echo __("Reset");?>" />
