                        ...
                        <form name="emailSettingsForm" id="emailSettingsForm" action="<?php echo(CATSUtility::getIndexName()); ?>?m=settings&amp;a=emailSettings" method="post">
                            ...
                            <table class="editTable" width="700">
                                ...
                                <tr id="fromAddressRow">
                                    ...
                                    <td class="tdData">
                                        <input type="checkbox" name="statusChangeContacted" <?php if($this->candidateJoborderStatusSendsMessage[PIPELINE_STATUS_CONTACTED]==1): ?>checked<?php endif; ?>><?php echo __("Status Change");?>: <?php echo __("Contacted");?><br />
                                        <input type="checkbox" name="statusChangeReplied" <?php if($this->candidateJoborderStatusSendsMessage[PIPELINE_STATUS_CANDIDATE_REPLIED]==1): ?>checked<?php endif; ?>><?php echo __("Status Change");?>: <?php echo __("Candidate Responded");?><br />
                                        <input type="checkbox" name="statusChangeQualifying" <?php if($this->candidateJoborderStatusSendsMessage[PIPELINE_STATUS_QUALIFYING]==1): ?>checked<?php endif; ?>><?php echo __("Status Change");?>: Qualifying<br />
                                        <input type="checkbox" name="statusChangeSubmitted" <?php if($this->candidateJoborderStatusSendsMessage[PIPELINE_STATUS_SUBMITTED]==1): ?>checked<?php endif; ?>><?php echo __("Status Change");?>: <?php echo __("Submitted");?><br />
                                        <input type="checkbox" name="statusChangeInterviewing" <?php if($this->candidateJoborderStatusSendsMessage[PIPELINE_STATUS_INTERVIEWING]==1): ?>checked<?php endif; ?>><?php echo __("Status Change");?>: <?php echo __("Interviewing");?><br />
                                        <input type="checkbox" name="statusChangeOffered" <?php if($this->candidateJoborderStatusSendsMessage[PIPELINE_STATUS_OFFERED]==1): ?>checked<?php endif; ?>><?php echo __("Status Change");?>: <?php echo __("Offered");?><br />
                                        <input type="checkbox" name="statusChangeDeclined" <?php if($this->candidateJoborderStatusSendsMessage[PIPELINE_STATUS_CLIENTDECLINED]==1): ?>checked<?php endif; ?>><?php echo __("Status Change");?>: <?php echo __("Client Declined");?><br />
                                        <input type="checkbox" name="statusChangePlaced" <?php if($this->candidateJoborderStatusSendsMessage[PIPELINE_STATUS_PLACED]==1): ?>checked<?php endif; ?>><?php echo __("Status Change");?>: <?php echo __("Placed");?><br />
