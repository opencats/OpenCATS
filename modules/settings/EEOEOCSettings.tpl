...
<?php TemplateUtility::printHeader(__('Settings'), array('modules/settings/validator.js', 'js/eeo.js')); ?>
...
<?php TemplateUtility::printTabs($this->active, $this->subActive); ?>
    <div id="main">
        ...
        <div id="contents">
            ...
            <p class="note"><?php echo __("Equal Employment Opportunity Tracking Settings");?></p>
                ...
                <tr>
                    <td>
                        <form name="EEOForm" id="EEOForm" action="<?php echo(CATSUtility::getIndexName()); ?>?m=settings&amp;a=eeo" method="post">
                            ...
                            <table class="editTable" width="100%">
                                <tr>
                                    <td class="tdVertical" style="width: 250px;">
                                        <?php echo __("Enable Candidate EEO Tracking");?>:
                                    </td>
                                    <td class="tdData">
                                ...
                                <tr>
                                    <td class="tdVertical" style="width: 250px;">
                                        <?php echo __("Track Ethnic Background");?>:
                                    </td>
                                    <td class="tdData">
                                ...
                                <tr>
                                    <td class="tdVertical" style="width: 250px;">
                                        <?php echo __("Track Vetran Status");?>:
                                    </td>
                                    <td class="tdData">
                                ...
                                <tr>
                                    <td class="tdVertical" style="width: 250px;">
                                        <?php echo __("Track Disability Status");?>:
                                    </td>
                                    <td class="tdData">
                            ...
                            <input type="submit" class="button" value="<?php echo __("Save Settings");?>" />&nbsp;
                            <br />
                            <br />
                        </form>
                    </td>
