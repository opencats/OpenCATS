...
<?php TemplateUtility::printHeader(__('Contacts'), array('js/highlightrows.js', 'js/export.js', 'js/dataGrid.js', 'js/dataGridFilters.js')); ?>
        ...
        <div id="contents"<?php echo !$this->totalContacts ? ' style="background-color: #E6EEFF; padding: 0px;"' : ''; ?>>
            ...
            <table width="100%">
                <tr>
                    ...
                    <td><h2><?php echo __("Contacts");?>: <?php echo __("Home");?></h2></td>
                    <td align="right">
                            ...
                            <table class="viewSelector">
                                <tr>
                                    ...
                                    <td valign="top" align="right" nowrap="nowrap">
                                        ...
                                        <label for="onlyMyContacts"><?php echo __("Only My Contacts");?></label>&nbsp;
                                    </td>
                                    <td valign="top" align="right" nowrap="nowrap">
                                        ...
                                        <label for="onlyHotContacts"><?php echo __("Only Hot Contacts");?></label>&nbsp;
                                    </td>
                                </tr>
                            </table>
                        </form>
            ...
            <p class="note">
                <span style="float:left;">
                    <?php echo __("Contacts");?> - <?php echo __("Page");?> <?php echo($this->dataGrid->getCurrentPageHTML()); ?>
                    (<?php echo($this->dataGrid->getNumberOfRows()); ?> <?php echo __("Items");?>)
                    <?php if ($this->dataGrid->getFilterValue('OwnerID') ==  $this->userID): ?>(<?php echo __("Only My Contacts");?>)<?php endif; ?>
                    <?php if ($this->dataGrid->getFilterValue('IsHot') == '1'): ?>(<?php echo __("Only Hot Contacts");?>)<?php endif; ?>
                </span>
            ...
            <table cellpadding="0" cellspacing="0" border="0" width="956">
                ...
                <td style="padding-left: 62px;" align="center" valign="center">
                    ...
                    <?php echo __("Add contacts to keep track of people you work with.");?>
                    </div>
