...
Feature: Access Level to objects check - main pages
  ...
  Scenario Outline: Job Orders module visibility
    ...
    And the page should <selectView> element "#view"
    And the page should <onlyMyJobOrders> contain "Only My Job Orders"
    And the page should <onlyHotJobOrders> contain "Only Hot Job Orders"
    And I should <filter> "Filter"
    And I should <rowsPerPage> "Rows Per Page"
    And I should <action> "Action"
    And I should <jobOrders> "Job Orders - Page"
#    And the page should <addToList> element "div[text()='Add to List']"
#    And the page should <export> contain "Export"
  ...
  Scenario Outline: Candidates module visibility
    ...
    And the page should <onlyMyCandidates> contain "Only My Candidates"
    And the page should <onlyHotCandidates> contain "Only Hot Candidates"
    And I should <filter> "Filter"
    And I should <rowsPerPage> "Rows Per Page"
    And I should <action> "Action"
   ...
   Examples:
    ...
    Scenario Outline: Companies module visibility
     ...
     And the page should <onlyMyCompanies> contain "Only My Companies"
     And the page should <onlyHotCompanies> contain "Only Hot Companies"
     And I should <filter> "Filter"
     And I should <rowsPerPage> "Rows Per Page"
     And I should <action> "Action"
   ...
   Scenario Outline: Contacts module visibility
     ...
     And the page should <onlyMyContacts> contain "Only My Contacts"
     And the page should <onlyHotContacts> contain "Only Hot Contacts"
     And I should <filter> "Filter"
     And I should <rowsPerPage> "Rows Per Page"
     And I should <action> "Action"
