...
echo "   docker-compose -f docker-compose.dev.yml exec db mysql -u opencats -popencats opencats < # API tables are now in modules/install/Schema.php (auto-applied)"
echo ""
