...
?>
    <div id="main">
        ...
        <div id="contents">
            ...
            <form method="post" action="<?php echo osatutil::getIndexName(); ?>?m=settings&a=careerPortalQuestionnairePreview&questionnaireID=<?php echo $this->questionnaireID; ?>" name="questionnairePreviewForm">
<?php endif; ?>
    <style>
