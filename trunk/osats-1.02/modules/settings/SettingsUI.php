...
*/
    ...
    private function onDeleteUser()
    {
        ...
        osatutil::transferRelativeURI('m=settings&a=manageUsers');
    }
    ...
    private function onCustomizeExtraFields()
    {
        ...
        osatutil::transferRelativeURI('m=settings&a=customizeExtraFields');
    }
  ...
  /*
        ...
        if (isset($_GET[$id = 'key']) && $_GET[$id] != '')
        {
            ...
            if ($license->setKey($key) !== false)
            {
                ...
                if (osatutil::changeConfigSetting('LICENSE_KEY', "'" . $key . "'"))
                {
                    $configWritten = true;
                }
            }
