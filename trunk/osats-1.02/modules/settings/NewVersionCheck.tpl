                ...
                <tr>
                    <td>
                        <?php if ($this->versionCheckPref): ?>
                            <p>
                                Your current version is: <span class="bold"><?php echo(osatutil::getVersion()); ?> Build <?php echo(osatutil::getBuild()); ?></span>.<br />
                        ...
                        <?php endif; ?>
                        <!-- <form action="<?php echo(osatutil::getIndexName()); ?>?m=settings&amp;a=administration" id="changeNewVersionForm" method="post">
