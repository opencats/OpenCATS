...
<?php TemplateUtility::printTabs($this->active, $this->subActive); ?>
    <div id="main">
        ...
        <div id="contents">
            ...
            <form name="careerPortalSettingsForm" id="careerPortalSettingsForm" action="<?php echo(osatutil::getIndexName()); ?>?m=settings&amp;a=careerPortalTemplateEdit" method="post">
