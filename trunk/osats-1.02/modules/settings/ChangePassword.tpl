...
<?php TemplateUtility::printTabs($this->active, $this->subActive); ?>
    <div id="main">
        ...
        <div id="contents">
            ...
            <form name="changePasswordForm" id="changePasswordForm" action="<?php echo(osatutil::getIndexName()); ?>?m=settings&amp;a=changePassword" method="post" onsubmit="return checkChangePasswordForm(document.changePasswordForm);">
