        ...
        <div id="contents">
            <table>
                <tr>
                    ...
                    <td><h2><?php _e('Reports');?></h2></td>
                </tr>
            </table>

            <p class="note"><?php _e('Reports');?></p>
                ...
                <tr>
                    ...
                    <td width="320" valign="top">
                        <table class="statisticsTable" width="300">
							...
							<tr class="evenTableRow">
                                <td align="left">
                                    <a href="<?php echo(osatutil::getIndexName()); ?>?m=reports&amp;a=showPlacementReport&amp;period=toDate" target="_blank"><?php _e('Total Placements');?></a>
                                </td>
