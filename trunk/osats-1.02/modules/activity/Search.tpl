    ...
    <div id="main">
        ...
        <div id="contents">
            ...
            <?php if (!empty($this->rs)): ?>
                <p class="note"><?php _e('Activities on '); echo($this->startDate['month'].'/'.$this->startDate['day'].'/'.$this->startDate['year'])?></p>
            ...
            <?php elseif ($this->isResultsMode): ?>
                <p class="note"><?php _e('No activities found on '); echo($this->startDate['month'] . '/' . $this->startDate['day'] . '/' . $this->startDate['year']); ?></p>
            <?php endif; ?>
        </div>
    </div>
