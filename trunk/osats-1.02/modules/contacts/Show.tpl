...
<?php TemplateUtility::printHeader(__('Contact'). ' - '.$this->data['firstName'].' '.$this->data['lastName'], array( 'js/activity.js', 'js/attachment.js')); ?>
<?php 
if (MYTABPOS == 'top') {
	osatutil::TabsAtTop();
        ...
        <div id="contents">
            <table>
                <tr>
                    ...
                    <td><h2><?php _e('Contacts')?>: <?php _e('Contact Details')?></h2></td>
                </tr>
            </table>

            <p class="note"><?php _e('Contact Details')?></p>
                ...
                <tr style="vertical-align:top;">
                    <td width="50%" height="100%">
                        <table class="detailsInside" height="100%">
                            <tr>
                                ...
                                <td class="data">
                                    <span class="bold">
                                        ...
                                        &nbsp;
                                        <a id="vCard" href="<?php echo(osatutil::getIndexName()); ?>?m=contacts&amp;a=downloadVCard&amp;contactID=<?php echo($this->contactID); ?>">
                            ...
                            <tr>
                                <td class="vertical"><?php _e('Company')?>:</td>
                                <td class="data">
                                    ...
                                    <?php if ($this->data['leftCompany']): ?>
                                        &nbsp;(<?php _e('no longer associated with company')?>)
                                    <?php endif; ?>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="vertical"><?php _e('Other Phone')?>:</td>
                    ...
                    <td width="50%" height="100%">
                        <table class="detailsInside" height="100%">
                            <tr>
                                <td class="vertical"><?php _e('Reports To')?>:</td>
                                <td class="data">
                                    <?php if($this->data['reportsTo'] == -1 || $this->data['reportsTo'] == 0 || $this->data['reportsToTitle'] == ''): ?>
                                        (<?php _e('_None')?>)
                                    <?php else: ?>
                                        <a href="<?php echo(osatutil::getIndexName()); ?>?m=contacts&amp;a=show&amp;contactID=<?php echo($this->data['reportsTo']); ?>">
                        ...
                        <table class="detailsInside">
                            ...
                            <tr>
                                ...
                                <?php if ($this->accessLevel >= ACCESS_LEVEL_EDIT): ?>
                                    <a href="#" onclick="showPopWin('<?php echo(osatutil::getIndexName()); ?>?m=contacts&amp;a=addActivityScheduleEvent&amp;contactID=<?php echo($this->contactID); ?>&amp;onlyScheduleEvent=true', 600, 200, null); return false;">
                                        <img src="images/calendar_add.gif" width="16" height="16" border="0" alt="Schedule Event" class="absmiddle" />&nbsp;<?php _e('Schedule Event')?>
                                    </a>
                                <?php endif; ?>
                                </td>
                            </tr>
            ...
            <?php if ($this->accessLevel >= ACCESS_LEVEL_EDIT): ?>
                <a id="edit_link" href="<?php echo(osatutil::getIndexName()); ?>?m=contacts&amp;a=edit&amp;contactID=<?php echo($this->contactID); ?>">
            ...
            <?php if ($this->accessLevel >= ACCESS_LEVEL_DELETE): ?>
                <a id="delete_link" href="<?php echo(osatutil::getIndexName()); ?>?m=contacts&amp;a=delete&amp;contactID=<?php echo($this->contactID); ?>" onclick="javascript:return confirm('Delete this candidate?');">
            ...
            <?php if ($this->privledgedUser): ?>
                <a id="history_link" href="<?php echo(osatutil::getIndexName()); ?>?m=settings&amp;a=viewItemHistory&amp;dataItemType=300&amp;dataItemID=<?php echo($this->contactID); ?>">
            ...
            <table class="sortable" width="925">
                <tr>
                    ...
                    <th align="right" width="15"><?php _e('Age')?></th>
                    <th align="right" width="10"><?php _e('S')?></th>
                    <th align="right" width="10"><?php _e('P')?></th>
            ...
            <div id="addActivityDiv">
                <?php if ($this->accessLevel >= ACCESS_LEVEL_EDIT): ?>
                    <a href="#" id="addActivityLink" title="Log an Activity / Schedule Event" onclick="showPopWin('<?php echo(osatutil::getIndexName()); ?>?m=contacts&amp;a=addActivityScheduleEvent&amp;contactID=<?php echo($this->contactID); ?>', 600, 375, null); return false;">
                        <img src="images/new_activity_inline.gif" width="16" height="16" class="absmiddle" title="Log an Activity / Schedule Event" alt="Log an Activity / Schedule Event" border="0" />&nbsp;<?php _e('Log an Activity / Schedule Event')?>
                    </a>
                <?php endif; ?>
