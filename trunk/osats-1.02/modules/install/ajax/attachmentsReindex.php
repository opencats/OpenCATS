...
/* We changed the code to do a sql lookup. See below.
...
/* Changed to look at the prior code above to determine ...
   if (file_exists('NSTALL_BLOCK') && ($_SESSION['CATS']->getAccessLevel() < ACCESS_LEVEL_SA || ModuleUtility::moduleExists('asp')))
{
    die('No permision.');
}
*/
