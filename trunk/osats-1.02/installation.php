                                ...
                                <tr>
                                    <td style="vertical-align: top; text-align: left;" id="allSpans">
                                        <div id="installLocked" style="display: none;">
                                            ...
                                            <p>If you need to rerun the installation: Log in to your mySQL db and change the value in the System table under Install from a 1 to Null. Then rerun the install below.</p><br />
                                        ...
                                        <div id="emptyDatabase" style="display: none;">
                                            ...
                                            <br />
                                            The installer is ready to set up your OSATS data. Please pick the way you want the installer to set up:<br />
                                            <br />
                                        ...
                                        <div id="catsUpToDate" style="display: none;">
                                            ...
                                            <br />
                                            The installer has detected an existing installation of OSATS.<br />
                                        ...
                                        <div id="installCompleteProd" style="display: none;">
                                            ...
                                            <br />
                                            <input type="button" class="button" value="Start OSATS" onclick="window.location.href='index.php';" />
                                        </div>
                                        ...
                                        <div id="testWarning" style="display: none;">
                                            ...
                                            <br />
                                            If you have any questions, visit the OSATS forums at <a href="http://www.google.com/forum/">http://WE NEED A WEB ADDRESS HERE!</a>.</td></tr></table><br />
                                            <input style="float: right;" type="button" class="button" value="Next -->" onclick="Installpage_populate('a=databaseConnectivity');" />
                                        </div>
                                        ...
                                        <div id="testFailedWarning" style="display: none;"><table class="footer_warning"><tr><td>One or more tests issued a warning. You may still proceed, but read the warnings carefully and address them if you can.<br />
                                            <br />
                                            If you have any questions, visit the OSATS forums at <a href="http://www.google.com/forum/">http://WE NEED A WEB ADDRESS HERE!</a>.</td></tr></table>
