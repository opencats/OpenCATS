    ...
    <div id="main">
        ...
        <div id="contents">
            ...
            <table class="searchTable" width="100%">
                <tr>
                    <td>
                        <form action="<?php echo(osatutil::getIndexName()); ?>?m=settings&amp;a=administration" id="changeSiteNameForm" onsubmit="return checkSiteNameForm(document.changeSiteNameForm);" method="post" autocomplete="off">
