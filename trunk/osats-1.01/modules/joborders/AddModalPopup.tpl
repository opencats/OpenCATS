...
<?php TemplateUtility::printModalHeader('Job Order', array('modules/joborders/validator.js')); ?>
    ...
    <p class="noteUnsized">Add Job Order</p>
        ...
        <input type="button" class="button"  value="Create Job Order" onclick="parentGoToURL('<?php echo(osatutil::getIndexName()); ?>?m=joborders&amp;a=add&amp;jobOrderID='+document.getElementById('copyFrom').value+'&amp;typeOfAdd='+typeOfAdd);"/>&nbsp;
