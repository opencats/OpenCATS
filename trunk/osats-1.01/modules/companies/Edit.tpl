    ...
    <div id="main">
        ...
        <div id="contents">
            ...
            <form name="editCompanyForm" id="editCompanyForm" action="<?php echo(osatutil::getIndexName()); ?>?m=companies&amp;a=edit" method="post" onsubmit="return checkEditForm(document.editCompanyForm);" autocomplete="off">
                ...
                <input type="button" class="button" name="back"   id="back"   value="Back to Details" onclick="javascript:goToURL('<?php echo(osatutil::getIndexName()); ?>?m=companies&amp;a=show&amp;companyID=<?php echo($this->companyID); ?>');" />
            </form>
