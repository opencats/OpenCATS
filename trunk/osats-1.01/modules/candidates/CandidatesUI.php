...
class CandidatesUI extends UserInterface
{
    ...
    public function publicAddCandidate($isModal, $transferURI, $moduleDirectory)
    {
        ...
        osatutil::transferRelativeURI($transferURI);
    }
    ...
    private function onDelete()
    {
        ...
        osatutil::transferRelativeURI('m=candidates&a=listByView');
    }
    ...
    private function administrativeHideShow()
    {
        ...
        osatutil::transferRelativeURI('m=candidates&a=show&candidateID='.$candidateID);
    }
