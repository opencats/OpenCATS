...
<html>
    <head>
        <title>OSATS (Open Source Applicant Tracking System) Install Routine</title>
                                ...
                                <tr>
                                    <td style="vertical-align: top; text-align: left;" id="allSpans">
                                        <div id="installLocked" style="display: none;">
                                            <span style="font-weight: bold;">You already have OSATS installed!</span><br />
                                            <p>If you need to rerun the installation, please delete the file named INSTALL_BLOCK from the root directory. Then proceed to &quot;Invoke the Install Routine&quot; below.</p><br />
                                        ...
                                        <div id="startInstall" style="display: none;">
                                            <span style="font: normal normal bold 18px Arial, Tahoma, sans-serif">Congratulations on finding the really truly open source Applicant Tracking System!</span><br />

                                            <p style="text-align: justify; margin-top: 15px;">Please be patient as a few items are tested....</p>
                                        </div>
                                        <div id="phpVersion" style="display: none;">
                                            ...
                                            <br />
                                            <span style="font-weight: bold;">The results are in!</span>
                                            <table class="test_output">
                                            <tr class="fail"><td>PHP 5.0.0 or greater is required to run OSATS. We noticed you are running version: <?php echo(phpversion()); ?>.</td></tr>
                                            </table>
                                        </div>
                                        <div id="databaseConnectivity" style="display: none;">
                                            <span style="font-weight: bold;">Database Configuration</span><br />
                                            <br />
                                            Are you ready to start the routine for setting up the MySQL database? We need information about your MySQL database to properly setup and continue.
                                            <br />
                                            <br />
                                            <table width="100%">
                                                <tr>
                                        ...
                                        <div id="resumeParsing" style="display: none;">
                                            ...
                                            <br />
                                            OSATS can index resumes for advanced searching with the assistance of external
                                            document processing software. You need to configure the software below
                                            to enable resume indexing.<br />
                                            <br />
                                            <a href="http://www.webaddresstothesoftwaregoeshere/" target="resumeParsingSoftwareDownload">
                                        ...
                                        <div id="mailSettings" style="display: none;">
                                            ...
                                            <br />
                                            Please enter your e-mail address (for where OSATS e-mails should be replied to, etc.).
                                            <br />
                                            <br />
                                            <table width="100%">
                                                <tr>
                                            ...
                                            <br />
                                            <br />
                                            OSATS sends automatic E-Mails on different events.  Please choose the mechanism for E-Mail delivery via CATS.<br />
                                            <br />
                                            <form name="mailForm">
                                            <table width="100%">
                                                <tr>
                                        ...
                                        <div id="installingComponentsMaint" style="display: none;">
                                            ...
                                            <br />
                                            Please wait while the OSATS database is brought up to date...<br />
											<br />
                                        ...
                                        <div id="emptyDatabase" style="display: none;">
                                            ...
                                            <br />
                                            The installer is ready to set up your OSATS data. Please pick the way you want the installer to set up CATS:<br />
                                            <br />
                                        ...
                                        <div id="unknownDataInDatabase" style="display: none;">
                                            ...
                                            <br />
                                            Please remove all of the-non OSATS tables to continue.<br />
                                            <br />
                                            <input type="button" class="button" value="Remove Non-CATS Tables" onclick="Installpage_populate('a=resetDatabase');">&nbsp;&nbsp;&nbsp;&nbsp;
                                        ...
                                        <div id="databaseUpgrade" style="display: none;">
                                            ...
                                            <br />
                                            The installer has scanned the database and found an older version of OSATS in the database (<span id="upgradeVersion"></span>). The installer
                                        ...
                                        <div id="catsUpToDate" style="display: none;">
                                            ...
                                            <br />
                                            The installer has detected an existing installation of CATS.<br />
                                            How would you like to proceed?<br />
                                            <br />
                                            <input type="radio" name="installgroupexists" id="currentCheckBox" value="current" checked />&nbsp;Use existing OSATS installation and automatically preform any necessary upgrade (recommended).<br />
                                            <br />
                                            <input type="radio" name="installgroupexists" value="empty" />&nbsp;Delete existing data and create a new installation.<br />
                                            <input type="radio" name="installgroupexists" value="demo" />&nbsp;Delete existing data and install the OSATS demonstration database.<br />
                                            <input type="radio" name="installgroupexists" value="restore" />&nbsp;Delete existing data and restore a previous OSATS installation from backup.<br />
                                            <br />
                                            If you choose to use the existing OSATS installation, you can always run<br />
                                        ...
                                        <div id="queryInstallBackup" style="display: none;">
                                            ...
                                            <br />
                                            Please upload the file OSATSbackup.bak into the <b>restore</b> directory. The installer will load the data
                                            out of the OSATSbackup.bak and set up your site accordingly, and then it will delete the file (preventing
                                            unauthorized access to the backup file).<br />
                                            <br />
                                            <input type="checkbox" id="continueRestoreCheck" onclick="if (this.checked) document.getElementById('continueRestoreButton').style.display = ''; else document.getElementById('continueRestoreButton').style.display = 'none';"> I have uploaded the file OSATSbackup.bak into the restore directory.<br />
                                            <br />
                                        ...
                                        <div id="queryInstallDemo" style="display: none;">
                                            ...
                                            <br />
                                            The database will be pre-populated with test data that you can use to train new users on using OSATS. You can login using
                                        ...
                                        <div id="installCompleteProd" style="display: none;">
                                            ...
                                            <br />
                                            The installer has finished installing OSATS! The installer has been disabled to prevent unauthorized access. To run the installer again, delete the file 'INSTALL_BLOCK' in your CATS directory.<br /><br />
                                            <br />
                                            You may now login to OSATS. If it is a new installation, use the following logon information:<br /><br />
                                            Username: admin<br />
                                            Password: cats<br />
                                            <br />
                                            <br />
                                            OSATS will periodically check for new versions of the software from catsone.com, and will send non confidential information about your
                                            installation including operating system version and web browser configuration back to OSATSone.com in order for us to improve CATS.  To see what information is sent, view
                                        ...
                                        <div id="pickOptionalComponents" style="display:none;">
                                            ...
                                            <br />
                                            OSATS comes with some optional features. You can enable them below.<br />
                                            <br />
                                        ...
                                        <div id="testWarning" style="display: none;">
                                            ...
                                            <br />
                                            If you have any questions, visit the OSATS forums at <a href="http://www.google.com/forum/">http://www.catsone.com/forum/</a>.</td></tr></table><br />
                                            <input style="float: right;" type="button" class="button" value="Next -->" onclick="Installpage_populate('a=databaseConnectivity');" />
                                        </div>
                                        ...
                                        <div id="testFailedWarning" style="display: none;"><table class="footer_warning"><tr><td>One or more tests issued a warning. You may still proceed, but read the warnings carefully and address them if you can.<br />
                                            <br />
                                            If you have any questions, visit the OSATS forums at <a href="http://www.google.com/forum/">http://www.catsone.com/forum/</a>.</td></tr></table>
                                        ...
                                        <div id="MySQLTestFailed" style="display: none;">
                                            <table class="footer_fail"><tr><td>One or more tests failed. Please correct the errors and try again.<br />
                                            <br />
                                            If you have any questions, visit the OSATS forums at <a href="http://www.catsone.com/forum/">http://www.catsone.com/forum/</a>.</td></tr></table>
                                        </div>
