...
insert  into `system`(`system_id`,`uid`,`available_version`,`date_version_checked`,`available_version_description`,`disable_version_check`) values (0,2618174,900,'2009-11-19 00:00:00','',0);
