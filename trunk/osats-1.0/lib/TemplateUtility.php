...
class TemplateUtility
{
    ...
    public static function printHeaderBlock($showTopRight = true)
    {
        ...
        echo '<tr>', "\n";
        echo '<td rowspan="2"><img src="images/applicationLogo.jpg" border="0" alt="OSATS Applicant Tracking System" /></td>', "\n";
        echo '</tr>', "\n";
        echo '</table>', "\n";
        ...
        if ($showTopRight)
        {
            ...
            {
                echo '<a href="http://www.nowhere.com" target="_blank">';
                echo '<img src="images/tabs/small_upgrade.jpg" border="0" /> ';
                echo '<b>This page is being cleaned up. OSATS will be free!</b></a>&nbsp;&nbsp;&nbsp;&nbsp;', "\n";
            }
