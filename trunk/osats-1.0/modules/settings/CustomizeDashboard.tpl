    ...
    <div id="main">
        ...
        <div id="contents">
            ...
            <table width="100%">
                <tr>
                    <td width="50%" valign="top">
                        <form name="addComponentForm" id="addComponentForm" action="<?php echo(CATSUtility::getIndexName()); ?>?m=settings&amp;a=customizeDashboard&amp;command=addComponent" method="post" autocomplete="off">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <?php if (!empty($data['moduleParameterFields'])): ?>
                                                <form action="<?php echo(CATSUtility::getIndexName()); ?>?m=settings&amp;a=customizeDashboard&amp;command=modifyComponent" method="post" autocomplete="off">
                                                    <input type="hidden" name="postback" value="postback" />
            ...
            <div style="text-align: center;">
                <input type="button" class="button" value="Finished" onclick="document.location.href='<?php echo(CATSUtility::getIndexName()); ?>?m=home';" />
            </div>
        </div>
    </div>
    <div id="bottomShadow"></div>
    
    <form action="<?php echo(CATSUtility::getIndexName()); ?>?m=settings&amp;a=customizeDashboard&amp;command=removeComponent" id="removeComponentForm" method="post" autocomplete="off">
         <input type="hidden" name="postback" value="postback" />
         <input type="hidden" name="dashboardComponentID" id="remove_componentID" value="" />
    </form>
    
    <form action="<?php echo(CATSUtility::getIndexName()); ?>?m=settings&amp;a=customizeDashboard&amp;command=moveComponent" id="moveComponentForm" method="post" autocomplete="off">
         <input type="hidden" name="postback" value="postback" />
