...
define('DATABASE_PASS', 'Puter2nvxp21');
 ...
 */
define('FORGOT_PASSWORD_FROM_NAME', 'AE OSATS');
...
define('MAIL_SMTP_HOST', "mitron3.ionatron.net");
define('MAIL_SMTP_PORT', 25);
define('MAIL_SMTP_AUTH', true);
define('MAIL_SMTP_USER', "itemailer");
define('MAIL_SMTP_PASS', "Magic123");
