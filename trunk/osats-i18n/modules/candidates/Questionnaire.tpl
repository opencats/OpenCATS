            ...
            <table cellpadding="0" cellspacing="0" width="100%" border="0">
                <tr>
                    <td align="left" valign="top">
                        <input type="button" class="button" value="<- Back to Candidate Profile" onclick="document.location.href='<?php echo osatutil::getIndexName(); ?>?m=candidates&a=show&candidateID=<?php echo $this->candidateID; ?>';" />
                    </td>
                    <td align="right">
