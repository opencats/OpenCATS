...
<?php TemplateUtility::printModalHeader(__('Login')); ?>
        <div align="center">
            ...
            <div style="font: normal normal 12px Arial, Tahoma, sans-serif">
                <?php _e('With bulk resumes, you can quickly upload many resumes into the system and make them searchable. When searching for resume keywords, when you see a bulk resume you wish to convert into a candidate, simply click the following icon on the search result.')?><img src="images/candidate_tiny.gif" height="12">
                <br />
            </div>
            <br />
            <br />
