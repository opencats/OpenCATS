                ...
                <table cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        <td style="padding-right: 10px;">
                            <input type="button" value="Rescan Documents" name="rescan" id="rescanButton" class="button" onclick="document.location.href='<?php echo osatutil::getIndexName(); ?>?m=import&a=importBulkResumes';" />
                        </td>
                        <td>
