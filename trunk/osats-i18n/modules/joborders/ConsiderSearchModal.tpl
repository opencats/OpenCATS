                        ...
                        <tr class="<?php TemplateUtility::printAlternatingRowClass($rowNumber); ?>">
                            <?php if (!$data['inPipeline']): ?>
                                <td valign="top" align="left">
                                    <a href="<?php echo(osatutil::getIndexName()); ?>?m=joborders&amp;a=addToPipeline&amp;getback=getback&amp;jobOrderID=<?php echo($this->jobOrderID); ?>&amp;candidateID=<?php $this->_($data['candidateID']); ?>">
                            ...
                            <td align="center" nowrap="nowrap">
                                <a href="#" title="Show Candidate" onclick="javascript:openCenteredPopup('<?php echo(osatutil::getIndexName()); ?>?m=candidates&amp;a=show&amp;display=popup&amp;candidateID=<?php $this->_($data['candidateID']); ?>', 'viewCandidateDetails', 1000, 675, true); return false;">
