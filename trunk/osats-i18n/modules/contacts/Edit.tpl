...
<?php TemplateUtility::printTabs($this->active); ?>
    <div id="main">
        ...
        <div id="contents">
            ...
            <form name="editContactForm" id="editContactForm" action="<?php echo(osatutil::getIndexName()); ?>?m=contacts&amp;a=edit" method="post" onsubmit="return checkEditForm(document.editContactForm);" autocomplete="off">
