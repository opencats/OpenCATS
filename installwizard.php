            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">Welcome to OpenCATS!</div>
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-md-9" id="allSpans">
                                    <div id="installLocked" style="display: none;">
                                        ...
                                        <input type="button" class="btn btn-success" value="Retry Installation" onclick="Installpage_populate('a=startInstall');">
                                    </div>
                                    ...
                                    <div id="databaseConnectivity" style="display: none;">
                                        <span style="font-weight: bold;">Database Configuration</span>
                                        ...
                                        <div class="form-horizontal">
                                            <div class="form-group">
                                                <label for="dbname" class="col-sm-3 control-label">Database Name: <span style="color: #ff0000">*</span></label>
                                                <div class="col-sm-9"><input type=text size=20 id="dbname" class="form-control" value="" /></div>
                                            </div>
                                            <div class="form-group">
                                                <label for="dbuser" class="col-sm-3 control-label">Database User: <span style="color: #ff0000">*</span></label>
                                                <div class="col-sm-9"><input type=text size=20 id="dbuser" class="form-control" value="" /></div>
                                            </div>
                                            <div class="form-group">
                                                <label for="dbpass" class="col-sm-3 control-label">Database Password:</label>
                                                <div class="col-sm-9"><input type="text" class="form-control" size="20" id="dbpass" value="" /></div>
                                            </div>
                                            <div class="form-group">
                                                <label for="dbhost" class="col-sm-3 control-label">Database Host: <span style="color: #ff0000">*</span></label>
                                                <div class="col-sm-9"><input type="text" size="20" id="dbhost" class="form-control" value="localhost" /> (usually <i>localhost</i>)</div>
                                            </div>
                                        </div>
                                    ...
                                    <div id="resumeParsing" style="display: none;">
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="docExecutable" id="docExecutable" class="form-control" />
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="pdfExecutable" id="pdfExecutable" class="form-control" />
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="htmlExecutable" id="htmlExecutable" class="form-control" />
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="rtfExecutable" id="rtfExecutable" class="form-control" />
                                        ...
                                        <br />
                                        <br />
                                        <input type="button" class="btn btn-success" value="Test Configuration" onclick="Installpage_populate('a=testResumeParsing&amp;docExecutable='+escape(document.getElementById('docExecutable').value)+'&amp;pdfExecutable='+escape(document.getElementById('pdfExecutable').value)+'&amp;htmlExecutable='+escape(document.getElementById('htmlExecutable').value)+'&amp;rtfExecutable='+escape(document.getElementById('rtfExecutable').value));" />&nbsp;&nbsp;&nbsp;
                                        <input type="button" class="btn btn-success" value="Skip this Step" onclick="document.getElementById('resumeParsing').style.display='none';showTextBlock('mailSettings');Installpage_populate('a=mailSettings');">
                                    </div>
                                    <div id="mailSettings" style="display: none;">
                                        ...
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td><input type="text" class="form-control" size="35" id="mailFromAddress" value="" /></td>
                                            </tr>
                                        </table>
                                        ...
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td>
                                                <select id="mailSupport" name="mailSupport" onChange="changeMailForm();" class="selectBox form-control">
                                        ...
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td><input type="text" class="form-control" size="20" id="mailSendmail" value="" /></td>
                                            </tr>
                                        </table>
                                        </div>
                                        ...
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td><input type="text" class="form-control" size="20" id="mailSmtpHost" value="" /></td>
                                            </tr>
                                            <tr>
                                                <td width="30%">SMTP Port: <span style="color: #ff0000">*</span></td>
                                                <td><input type="text" class="form-control" size="20" id="mailSmtpPort" value="" /></td>
                                            </tr>
                                        </table>
                                        </div>
                                        ...
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td><input type="text" class="form-control" size="20" id="mailSmtpUsername" value="" /></td>
                                            </tr>
                                            <tr>
                                                <td width="30%">SMTP Password: <span style="color: #ff0000">*</span></td>
                                                <td><input type="text" class="form-control" size="20" id="mailSmtpPassword" value="" /></td>
                                            </tr>
                                        </table>
                                        </div>
                                    ...
                                    <div id="emptyDatabase" style="display: none;">
                                        ...
                                        <input style="float: right;" type="button" class="btn btn-success" value="Next" onclick="Installpage_populate('a=selectDBType&amp;type='+escape(getCheckedValue(document.getElementsByName('installgroup'))));" />
                                    </div>
                                    <div id="unknownDataInDatabase" style="display: none;">
                                        ...
                                        <br />
                                        <input type="button" class="btn btn-success" value="Remove Non-OpenCATS Tables" onclick="Installpage_populate('a=resetDatabase');">&nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type="button" class="btn btn-success" value="Do Nothing and Retry Installation" onclick="Installpage_populate('a=startInstall');">
                                    </div>
                                    <div id="databaseUpgrade" style="display: none;">
                                        ...
                                        <br />
                                        <input style="float: right;" type="button" class="btn btn-success" value="Next" onclick="document.getElementById('databaseUpgrade').style.display='none';showTextBlock('installingComponentsMaint');Installpage_populate('a=upgradeCats');" />
                                    </div>
                                    <div id="catsUpToDate" style="display: none;">
                                        ...
                                        <br />
                                        <input style="float: right;" type="button" class="btn btn-success" value="Next" onclick="if (getCheckedValue(document.getElementsByName('installgroupexists')) == 'current') Installpage_populate('a=resumeParsing'); else {document.getElementById('catsUpToDate').style.display='none';showTextBlock('queryResetDatabase');}" />
                                    </div>
                                    <div id="queryInstallBackup" style="display: none;">
                                        ...
                                        <br />
                                        <input type="button" class="btn btn-success" value="Continue" id="continueRestoreButton" style="display: none;" onclick="document.getElementById('queryInstallBackup').style.display='none';showTextBlock('installingComponents');Installpage_populate('a=restoreFromBackup');" />&nbsp;&nbsp;&nbsp;
                                        <input type="button" class="btn btn-success" value="Cancel" onclick="Installpage_populate('a=detectRevision');" /><br /><br />
                                    </div>
                                    <div id="queryInstallDemo" style="display: none;">
                                        ...
                                        <br />
                                        <input type="button" class="btn btn-success" value="Continue" onclick="document.getElementById('queryInstallDemo').style.display='none';showTextBlock('installingComponents');Installpage_populate('a=onLoadDemoData');" />&nbsp;&nbsp;&nbsp;
                                        <input type="button" class="btn btn-success" value="Cancel" onclick="Installpage_populate('a=detectRevision');" /><br /><br />
                                    </div>
                                    <div id="installCompleteProd" style="display: none;">
                                        ...
                                        <br />
                                        <input type="button" class="btn btn-success" value="Start OpenCATS" onclick="window.location.href='index.php';" />
                                    </div>
                                    ...
                                    <div id="queryResetDatabase" style="display: none;">
                                        ...
                                        <br />
                                        <input type="button" class="btn btn-success" value="Yes - Delete All Data" onclick="document.getElementById('queryResetDatabase').style.display='none';showTextBlock('installingComponents');Installpage_populate('a=resetDatabase&amp;type='+escape(getCheckedValue(document.getElementsByName('installgroupexists'))));" style="width:240px;" />&nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type="button" class="btn btn-success" value="No - Do Not Delete Data" onclick="Installpage_populate('a=detectRevision');" style="width:240px;" />
                                    </div>
                                    <div id="pickOptionalComponents" style="display:none;">
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                <td style="padding-bottom: 10px;"><?php if (!isset($php4)) TemplateUtility::printTimeZoneSelect('timeZone', 'width: 420px;', 'form-control', OFFSET_GMT); ?></td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <select id="dateFormat" name="dateFormat" class="selectBox form-control">
                                    ...
                                    <div id="subFormBlock" style="font: normal normal normal 9pt Arial, Tahoma, sans-serif;"></div>

                                    <div id="testPassed" style="display: none;">
                                        <table class="footer_pass"><tr><td>All tests passed successfully!</td></tr></table>
                                        <br />
                                        <input style="float: right;" type="button" class="btn btn-success" value="Next" onclick="Installpage_populate('a=databaseConnectivity');" />
                                    </div>
                                    ...
                                    <div id="testWarning" style="display: none;">
                                        <div class="alert alert-warning">One or more tests issued a warning. You may still proceed, but read the warnings carefully and address them if you can.<br />
                                        <br />
                                        If you have any questions, visit the OpenCATS forums at <a href="http://www.opencats.org/forums/">http://www.opencats.org/forums/</a>.</div>
                                    ...
                                    <div id="MySQLTestPassed" style="display: none;">
                                        <table class="footer_pass"><tr><td>All tests passed successfully!</td></tr></table>
                                        <br />
                                        <input style="float: right;" type="button" class="btn btn-success" value="Next" onclick="Installpage_populate('a=detectRevision');" />
                                    </div>
