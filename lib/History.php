...
class History
{
     ...
     */
    public function storeHistoryChanges(
        $dataItemType,
        $dataItemID,
        $preHistory,
        $postHistory
        ...
        /* Make a description. */
        $description = sprintf(
            '(USER) changed field(s): %s.',
            implode(', ', $changedHistory)
        );
     ...
     * @return query response
     */
    public function storeHistoryCatagorized(
        $dataItemType,
        $dataItemID,
        $category,
        $description
     ...
     * @return query response
     */
    public function storeHistoryData(
        $dataItemType,
        $dataItemID,
        $category,
        $before,
     ...
     * @return query response
     */
    public function storeHistorySimple(
        $dataItemType,
        $dataItemID,
        $description
    ) {
