...
class awLabel implements awPositionable
{
    ...
    {
        $this->setCallbackFunction(fn ($value) => sprintf($format, $value));
    }
     ...
     */
    public function setBackground(mixed $background)
    {
     ...
     * @return Text
     */
    public function getText(mixed $key)
    {
     ...
     * @param int $key Text position in the array of texts (default to zero)
     */
    public function drawSpecial(awDrawer $drawer, awPoint $p, $theText, $key = 0)
    {
