...
class awDrawer
{
     ...
     * @param int $height Ellipse height
     */
    public function filledEllipse(mixed $background, awPoint $center, $width, $height)
    {
     ...
     * @param awLine $line Rectangle diagonale
     */
    public function filledRectangle(mixed $background, awLine $line)
    {
        $p1 = $line->p1;
        $p2 = $line->p2;
     ...
     * @param Polygon A polygon
     */
    public function filledPolygon(mixed $background, awPolygon $polygon)
    {
        if ($background instanceof awColor) {
            $points = $this->getPolygonPoints($polygon);
            $rgb = $background->getColor($this->resource);
