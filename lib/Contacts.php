...
class ContactsDataGrid extends DataGrid
{
    ...
    public function __construct($instanceName, $siteID, $parameters, $misc = 0)
    {
        ...
        $this->_classColumns = ['First Name' =>     ['select'         => 'contact.first_name AS firstName', 'pagerRender'    => 'if ($rsData[\'isHot\'] == 1) $className =  \'jobLinkHot\'; else $className = \'jobLinkCold\'; return \'<a href="'.CATSUtility::getIndexName().'?m=contacts&amp;a=show&amp;contactID=\'.$rsData[\'contactID\'].\'" class="\'.$className.\'">\'.htmlspecialchars($rsData[\'firstName\']).\'</a>\';', 'sortableColumn' => 'firstName', 'pagerWidth'     => 75, 'pagerOptional'  => false, 'alphaNavigation'=> true, 'filter'         => 'contact.first_name'], 'Last Name' =>      ['select'         => 'contact.last_name AS lastName', 'sortableColumn'  => 'lastName', 'pagerRender'     => 'if ($rsData[\'isHot\'] == 1) $className =  \'jobLinkHot\'; else $className = \'jobLinkCold\'; return \'<a href="'.CATSUtility::getIndexName().'?m=contacts&amp;a=show&amp;contactID=\'.$rsData[\'contactID\'].\'" class="\'.$className.\'">\'.htmlspecialchars($rsData[\'lastName\']).\'</a>\';', 'pagerWidth'      => 85, 'pagerOptional'   => false, 'alphaNavigation' => true, 'filter'         => 'contact.last_name'], 'Company' =>     ['select'         => 'company.name AS name,'.
                                                   'company.company_id as companyID', 'pagerRender'    => 'if ($rsData[\'isHot\'] == 1) $className =  \'jobLinkHot\'; else $className = \'jobLinkCold\'; return \'<a href="'.CATSUtility::getIndexName().'?m=companies&amp;a=show&amp;companyID=\'.$rsData[\'companyID\'].\'" class="\'.$className.\'">\'.htmlspecialchars($rsData[\'name\']).\'</a>\';', 'sortableColumn' => 'name', 'pagerWidth'     => 60, 'pagerOptional'  => true, 'alphaNavigation'=> true, 'filter'         => 'company.name'], 'Title' =>        ['select'  => 'contact.title AS title', 'sortableColumn'    => 'title', 'pagerWidth'   => 140, 'alphaNavigation' => true, 'pagerOptional'  => true, 'filter'         => 'contact.title'], 'Department' =>  ['select'  => 'company_department.company_department_id AS companyDepartmentID, company_department.name as department', 'join'     => 'LEFT JOIN company_department on company_department.company_department_id = contact.company_department_id', 'sortableColumn'    => 'department', 'pagerWidth'   => 120, 'alphaNavigation' => true, 'pagerOptional'  => true, 'filter'         => 'company_department.department'], 'Work Phone' =>   ['select'  => 'contact.phone_work AS workPhone', 'sortableColumn'    => 'workPhone', 'pagerWidth'   => 140, 'alphaNavigation' => false, 'pagerOptional'  => true, 'filter'         => 'contact.work_phone'], 'Cell Phone' =>    ['select'  => 'contact.phone_cell AS cellPhone', 'sortableColumn'    => 'cellPhone', 'pagerWidth'   => 140, 'alphaNavigation' => false, 'pagerOptional'  => true, 'filter'         => 'contact.phone_cell'], 'Other Phone' =>   ['select'  => 'contact.phone_other AS otherPhone', 'sortableColumn'    => 'otherPhone', 'pagerWidth'   => 140, 'alphaNavigation' => false, 'pagerOptional'  => true, 'filter'         => 'contact.phone_other'], 'E-Mail' =>         ['select'   => 'contact.email1 AS email1', 'sortableColumn'     => 'email1', 'pagerWidth'    => 80, 'filter'         => 'contact.email1'], '2nd E-Mail' =>     ['select'   => 'contact.email2 AS email2', 'sortableColumn'     => 'email2', 'pagerWidth'    => 80, 'filter'         => 'contact.email2'], 'Address' =>        ['select'   => 'contact.address AS address', 'sortableColumn'     => 'address', 'pagerWidth'    => 250, 'alphaNavigation' => true, 'filter'         => 'contact.address'], 'City' =>           ['select'   => 'contact.city AS city', 'sortableColumn'     => 'city', 'pagerWidth'    => 80, 'alphaNavigation' => true, 'filter'         => 'contact.city'], 'State' =>          ['select'   => 'contact.state AS state', 'sortableColumn'     => 'state', 'filterType' => 'dropDown', 'pagerWidth'    => 50, 'alphaNavigation' => true, 'filter'         => 'contact.state'], 'Zip' =>            ['select'  => 'contact.zip AS zip', 'sortableColumn'    => 'zip', 'pagerWidth'   => 50, 'filter'         => 'contact.zip'], 'Misc Notes' =>     ['select'  => 'contact.notes AS notes', 'sortableColumn'    => 'notes', 'pagerWidth'   => 300, 'filter'         => 'contact.notes'], 'Owner' =>         ['pagerRender'      => 'return StringUtility::makeInitialName($rsData[\'ownerFirstName\'], $rsData[\'ownerLastName\'], false, LAST_NAME_MAXLEN);', 'exportRender'     => 'return $rsData[\'ownerFirstName\'] . " " .$rsData[\'ownerLastName\'];', 'sortableColumn'     => 'ownerSort', 'pagerWidth'    => 75, 'alphaNavigation' => true, 'pagerOptional'  => true, 'filter'         => 'CONCAT(owner_user.first_name, owner_user.last_name)'], 'Created' =>       ['select'   => 'DATE_FORMAT(contact.date_created, \'%m-%d-%y\') AS dateCreated', 'pagerRender'      => 'return $rsData[\'dateCreated\'];', 'sortableColumn'     => 'dateCreatedSort', 'pagerWidth'    => 60, 'filterHaving' => 'DATE_FORMAT(contact.date_created, \'%m-%d-%y\')'], 'Modified' =>      ['select'   => 'DATE_FORMAT(contact.date_modified, \'%m-%d-%y\') AS dateModified', 'pagerRender'      => 'return $rsData[\'dateModified\'];', 'sortableColumn'     => 'dateModifiedSort', 'pagerWidth'    => 60, 'pagerOptional' => false, 'filterHaving' => 'DATE_FORMAT(contact.date_modified, \'%m-%d-%y\')'], 'OwnerID' =>       ['select'    => '', 'filter'    => 'contact.owner', 'pagerOptional' => false, 'filterable' => false, 'filterDescription' => 'Only My Contacts'], 'IsHot' =>         ['select'    => '', 'filter'    => 'contact.is_hot', 'pagerOptional' => false, 'filterable' => false, 'filterDescription' => 'Only Hot Contacts']];

        if (US_ZIPS_ENABLED)
        {
            $this->_classColumns['Near Zipcode'] =
                               ['select'  => 'contact.zip AS zip', 'filter' => 'contact.zip', 'pagerOptional' => false, 'filterTypes'   => '=@'];
        }
