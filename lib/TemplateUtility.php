...
class TemplateUtility
{
    ...
    public static function printHeaderBlock($showTopRight = true)
    {
        ...
        if ($showTopRight) {
            ...
            } elseif ($_SESSION['CATS']->getAccessLevel(ACL::SECOBJ_ROOT) == ACCESS_LEVEL_READ) {
     ...
     */
    public static function printTimeZoneSelect(
        $selectID,
        $selectStyle,
        $selectClass,
        $selectedTimeZone
    ...
    private static function _printCommonHeader($pageTitle, $headIncludes = [])
    {
        ...
        echo '<script type="text/javascript" src="js/jquery-1.12.4.js' . $javascriptAntiCache . '"></script>', "\n";
